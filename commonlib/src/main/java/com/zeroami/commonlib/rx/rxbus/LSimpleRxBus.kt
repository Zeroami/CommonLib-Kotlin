...
inline fun <reified T> subscribeSticky(noinline block: (T) -> Unit) : Disposable = LRxBus.subscribeSticky(T::class.java,block)

inline fun <reified T> subscribeSticky(action : String ,noinline block: (T) -> Unit) : Disposable = LRxBus.subscribeSticky(T::class.java,action,block)

fun subscribeStickyAction(action : String, block: () -> Unit) : Disposable = LRxBus.subscribeStickyAction(action,block)
