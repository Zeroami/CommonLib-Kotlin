 ...
 * @author Zeroami
 */
class LMapDeserializerDoubleAsIntFix : JsonDeserializer<Map<String, Any>> {

    @Throws(JsonParseException::class)
    override fun deserialize(jsonElement: JsonElement, type: Type, jsonDeserializationContext: JsonDeserializationContext): Map<String, Any>? {
